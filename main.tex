        ...
        \subsection*{I risultati ottenuti}
            ...
            \begin{table}[h!]
                ...
                \subtable[fit picchi europio-152\label{tab:fit_picchi_europio_germanio}]
                    {
                        $
                        \input{dati/output/fit_picchi_europio_germanio.tex}%
                        $
                    }
                \subtable[fit cobalto-60\label{tab:fit_picchi_cobalto_germanio}]
                    {
                        $
                        \input{dati/output/fit_picchi_cobalto_germanio.tex}%
                        $
                    }
                \subtable[fit cobalto-60 (alto rateo)\label{tab:fit_picchi_cobalto_germanio_highrate}]
                    {
                        $
                        \input{dati/output/fit_picchi_cobalto_germanio_highrate.tex}%
                        $
                    }
                ...
                \subtable[fit lineare provvisorio]
                    {
                        $
                        \begin{array}{cc}
                            (\si{\kilo\electronvolt}\:/\:canali)&(\si{\kilo\electronvolt})\\
                            \toprule
                            \beta_0       & \alpha_0      \\
                            \midrule
                            0.32&16.15\\
            ...
            \begin{table}[h!]
                ...
                $
                \input{dati/output/fit_calibrazione.tex}
                $
            \end{table}
            ...
            \subsection*{I risultati ottenuti}
                ...
                \begin{table}[h!]
                    ...
                    \subtable[Europio-152]
                        {
                            $
                            \input{dati/output/risoluzioni_europio.tex}
                            $
                        }
                    \subtable[Cobalto-60]
                        {
                            $
                            \input{dati/output/risoluzioni_cobalto.tex}
                            $
                        }
                    \subtable[Cobalto-60 (alto rateo)]
                        {
                            $
                            \input{dati/output/risoluzioni_cobalto_highrate.tex}
                            $
                        }
                \end{table}
                ...
                \begin{table}[h!]
                    ...
                    $
                    \input{dati/output/fit_risoluzione.tex}
                    $
                \end{table}
        ...
        \section{Il rumore elettronico}
            ...
            \subsection*{I risultati ottenuti}
                ...
                \begin{table}[h!]
                    ...
                    $
                    \input{dati/output/fit_picchi_pulser_germanio.tex}
                    $
                \end{table}
            ...
            La tabella \ref{tab:efficienze} mostra, per l'europio-152 e per il cobalto-60, le efficienze in percentuali di ciascun picco con la corrispondente incertezza.
                \begin{table}[h!]
                    ...
                    \subtable[Europio-152]
                        {
                            $
                            \input{dati/output/efficienze_europio.tex}
                            $
                        }
                    \subtable[Cobalto-60]
                        {
                            $
                            \input{dati/output/efficienze_cobalto.tex}
                            $
                        }
                    \subtable[Cobalto-60 (alto rateo)]
                        {
                            $
                            \input{dati/output/efficienze_cobalto_highrate.tex}
                            $
                        }
                \end{table}
                ...
                \begin{table}[h!]
                    ...
                    $
                    \input{dati/output/fit_efficienza.tex}
                    $
                \end{table}
        ...
        \subsection*{I risultati ottenuti}   
            ...
            \begin{table}[h!]
                ...
                \label{tab:fit_picchi_incognita_germanio}
                    $
                    \input{dati/output/fit_picchi_incognita_germanio.tex}%
                    $
            \end{table}
            ...
            \begin{table}[h!]
                ...
                $
                \input{dati/output/energie_incognita_germanio.tex}
                $
            \end{table}
        ...
        \subsection*{I risultati ottenuti}
            ...
            \begin{table}[h!]
                ...
                \subtable[cobalto-60 nel BaF]
                    {
                        $
                        \input{dati/output/fit_picchi_cobalto_baf.tex}%
                        $
                    }
                \subtable[cobalto-60 nel BaF (con soglia)]
                    {
                        $
                        \input{dati/output/fit_picchi_cobalto_baf_monopicco.tex}%
                        $
                    }
                \subtable[cobalto-60 nell'HpGe (con soglia)]
                    {
                        $
                        \input{dati/output/fit_picchi_cobalto_germanio_monopicco.tex}%
                        $
                    }
            \end{table}
